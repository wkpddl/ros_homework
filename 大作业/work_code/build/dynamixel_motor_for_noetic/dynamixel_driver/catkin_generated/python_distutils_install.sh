...
echo_and_run cd "/home/ubuntuber/ros_se/src/dynamixel_motor_for_noetic/dynamixel_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ubuntuber/ros_se/src/dynamixel_motor_for_noetic/dynamixel_driver/setup.py" \
     \
    build --build-base "/home/ubuntuber/ros_se/build/dynamixel_motor_for_noetic/dynamixel_driver" \
    install \
    --root="${DESTDIR-/}" \
