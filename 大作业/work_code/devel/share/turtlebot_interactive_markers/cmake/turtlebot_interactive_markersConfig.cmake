...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_interactive_markers_SOURCE_PREFIX /home/ubuntuber/ros_se/src/turtlebot_viz/turtlebot_interactive_markers)
  set(turtlebot_interactive_markers_DEVEL_PREFIX /home/ubuntuber/ros_se/devel)
  ...
  set(turtlebot_interactive_markers_INSTALL_PREFIX /home/ubuntuber/ros_se/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntuber/ros_se/src/turtlebot_viz/turtlebot_interactive_markers/${idir}'.  ${_report}")
    endif()
