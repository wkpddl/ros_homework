...
if("TRUE" STREQUAL "TRUE")
  set(yocs_cmd_vel_mux_SOURCE_PREFIX /home/ubuntuber/ros_se/src/yocs_cmd_vel_mux)
  set(yocs_cmd_vel_mux_DEVEL_PREFIX /home/ubuntuber/ros_se/devel)
  ...
  set(yocs_cmd_vel_mux_INSTALL_PREFIX /home/ubuntuber/ros_se/install)
...
if(NOT "/home/ubuntuber/ros_se/devel/include;/home/ubuntuber/ros_se/src/yocs_cmd_vel_mux/include " STREQUAL " ")
  set(yocs_cmd_vel_mux_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntuber/ros_se/devel/include;/home/ubuntuber/ros_se/src/yocs_cmd_vel_mux/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_cmd_vel_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntuber/ros_se/src/yocs_cmd_vel_mux/${idir}'.  ${_report}")
    endif()
