...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_follower_SOURCE_PREFIX /home/ubuntuber/ros_se/src/turtlebot_apps/turtlebot_follower)
  set(turtlebot_follower_DEVEL_PREFIX /home/ubuntuber/ros_se/devel)
  ...
  set(turtlebot_follower_INSTALL_PREFIX /home/ubuntuber/ros_se/install)
...
if(NOT "/home/ubuntuber/ros_se/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntuber/ros_se/src/turtlebot_apps/turtlebot_follower/${idir}'.  ${_report}")
    endif()
