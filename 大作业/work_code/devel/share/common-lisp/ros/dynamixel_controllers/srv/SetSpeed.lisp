...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<SetSpeed-request> is deprecated: use dynamixel_controllers-srv:SetSpeed-request instead.")))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <SetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_controllers-srv:speed-val is deprecated.  Use dynamixel_controllers-srv:speed instead.")
  (speed m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<SetSpeed-response> is deprecated: use dynamixel_controllers-srv:SetSpeed-response instead.")))
