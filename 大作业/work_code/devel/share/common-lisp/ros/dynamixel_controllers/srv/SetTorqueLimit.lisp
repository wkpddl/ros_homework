...
(cl:defmethod cl:initialize-instance :after ((m <SetTorqueLimit-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTorqueLimit-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<SetTorqueLimit-request> is deprecated: use dynamixel_controllers-srv:SetTorqueLimit-request instead.")))

(cl:ensure-generic-function 'torque_limit-val :lambda-list '(m))
(cl:defmethod torque_limit-val ((m <SetTorqueLimit-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_controllers-srv:torque_limit-val is deprecated.  Use dynamixel_controllers-srv:torque_limit instead.")
  (torque_limit m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetTorqueLimit-request>)))
  ...
  (cl:format cl:nil "# Set maximum motor torque in percenatge (0 - no torque to 1 - maximum torque)~%~%float64 torque_limit~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetTorqueLimit-request)))
  "Returns full string definition for message of type 'SetTorqueLimit-request"
  (cl:format cl:nil "# Set maximum motor torque in percenatge (0 - no torque to 1 - maximum torque)~%~%float64 torque_limit~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetTorqueLimit-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTorqueLimit-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<SetTorqueLimit-response> is deprecated: use dynamixel_controllers-srv:SetTorqueLimit-response instead.")))
