...
(cl:defmethod cl:initialize-instance :after ((m <SetComplianceMargin-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetComplianceMargin-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<SetComplianceMargin-request> is deprecated: use dynamixel_controllers-srv:SetComplianceMargin-request instead.")))

(cl:ensure-generic-function 'margin-val :lambda-list '(m))
(cl:defmethod margin-val ((m <SetComplianceMargin-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_controllers-srv:margin-val is deprecated.  Use dynamixel_controllers-srv:margin instead.")
  (margin m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetComplianceMargin-request>)))
  ...
  (cl:format cl:nil "# Range is 0 to 255, larger value = more error~%~%uint8 margin~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetComplianceMargin-request)))
  "Returns full string definition for message of type 'SetComplianceMargin-request"
  (cl:format cl:nil "# Range is 0 to 255, larger value = more error~%~%uint8 margin~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetComplianceMargin-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetComplianceMargin-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<SetComplianceMargin-response> is deprecated: use dynamixel_controllers-srv:SetComplianceMargin-response instead.")))
