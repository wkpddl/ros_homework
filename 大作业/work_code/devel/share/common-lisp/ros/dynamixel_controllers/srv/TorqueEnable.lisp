...
(cl:defmethod cl:initialize-instance :after ((m <TorqueEnable-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TorqueEnable-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<TorqueEnable-request> is deprecated: use dynamixel_controllers-srv:TorqueEnable-request instead.")))

(cl:ensure-generic-function 'torque_enable-val :lambda-list '(m))
(cl:defmethod torque_enable-val ((m <TorqueEnable-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_controllers-srv:torque_enable-val is deprecated.  Use dynamixel_controllers-srv:torque_enable instead.")
  (torque_enable m))
...
(cl:defmethod cl:initialize-instance :after ((m <TorqueEnable-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TorqueEnable-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_controllers-srv:<TorqueEnable-response> is deprecated: use dynamixel_controllers-srv:TorqueEnable-response instead.")))
