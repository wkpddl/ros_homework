...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_calibration_SOURCE_PREFIX /home/ubuntuber/ros_se/src/turtlebot_apps/turtlebot_calibration)
  set(turtlebot_calibration_DEVEL_PREFIX /home/ubuntuber/ros_se/devel)
  ...
  set(turtlebot_calibration_INSTALL_PREFIX /home/ubuntuber/ros_se/install)
...
if(NOT "/home/ubuntuber/ros_se/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntuber/ros_se/src/turtlebot_apps/turtlebot_calibration/${idir}'.  ${_report}")
    endif()
