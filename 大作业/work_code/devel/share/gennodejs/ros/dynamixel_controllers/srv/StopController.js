...
class StopControllerRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StopControllerRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new StopControllerRequest(null);
...
class StopControllerResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StopControllerResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new StopControllerResponse(null);
...
module.exports = {
  ...
  md5sum() { return 'b3f1f861a8aef49071034d2f06308f6e'; },
  datatype() { return 'dynamixel_controllers/StopController'; }
};
